...
User.create!(student_id: 3, name: 'Quetzal', last_name: 'Quetzal',  email: 'admin@itesm.mx', password:'123456', password_confirmation:'123456', role: 3)
# Timetables
## Monday
...
Group.create(user_id: 2, timetable_id: 11, classroom: "A2-301", seats: 30)
Group.create(user_id: 2, timetable_id: 12, classroom: "A2-303", seats: 30)
Group.create(user_id: 2, timetable_id: 13, classroom: "A2-304", seats: 30)
Group.create(user_id: 2, timetable_id: 14, classroom: "CI-104", seats: 30)
Group.create(user_id: 2, timetable_id: 15, classroom: "CI-606", seats: 30)
Group.create(user_id: 2, timetable_id: 16, classroom: "CI-545", seats: 30)
Group.create(user_id: 2, timetable_id: 17, classroom: "CI-301", seats: 30)
Group.create(user_id: 2, timetable_id: 18, classroom: "CI-109", seats: 30)
Group.create(user_id: 2, timetable_id: 19, classroom: "CI-221", seats: 30)
Group.create(user_id: 2, timetable_id: 20, classroom: "A1-209", seats: 30)
Group.create(user_id: 2, timetable_id: 21, classroom: "A2-111", seats: 30)
Group.create(user_id: 2, timetable_id: 22, classroom: "A2-331", seats: 30)
Group.create(user_id: 2, timetable_id: 23, classroom: "A2-109", seats: 30)
Group.create(user_id: 2, timetable_id: 24, classroom: "A1-107", seats: 30)
Group.create(user_id: 2, timetable_id: 25, classroom: "A4-221", seats: 30)
Group.create(user_id: 2, timetable_id: 26, classroom: "A4-312", seats: 30)
